...
We can see here that we have created a count of how many of each of the 5000 sets of 10 flips resulted in 0, 1, 2, $\ldots$, up to 10 heads.  Note the use of the `group_by` and `summarize` functions from Chapter \@ref(wrangling) here.
...
An R script file of all R code used in this chapter is available [here](http://moderndive.com/scripts/07-sim.R).
